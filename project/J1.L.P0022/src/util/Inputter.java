...
public class Inputter {
        ...
        while (true) {
            try {
                ...
                System.out.println (new StringBuilder ()
                        .append ("Please enter a number between ")
                        .append (min)
                        .append (" and ")
                        .append (max)
                        .toString ());
    ...
    public static int getBirthDate (String prompt) {
        ...
        while (true) {
            try {
                ...
                System.out.println (new StringBuilder ()
                        .append ("Birth year must be between 1900 and ")
    ...
    public static String getGraduationRank (String prompt) {
        ...
        for (i = 0; i < Constants.GRADUATION_RANKS_ARRAY.length; i++) {
            System.out.println (new StringBuilder ()
                    .append (i + 1)
                    .append (". ")
                    .append (Constants.GRADUATION_RANKS_ARRAY[i])
                    .toString ());
        }

        // Get user choice (1-4)
        choice = getInteger ("Choose rank (1-4): ", 1, 4);

        // Return selected rank (subtract 1 for zero-based array index)
        return Constants.GRADUATION_RANKS_ARRAY[choice - 1];
    }
